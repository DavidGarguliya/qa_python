...
- `test_add_new_book_invalid_title_not_added` параметризация: пустое имя и имя >40 символов не сохраняются, ровно 40 символов сохраняется.
- `test_add_new_book_duplicate_not_added` повторное добавление одной книги не создает дубликат.
...
- `test_add_book_in_favorites_ignores_unknown_book` попытка добавить в избранное книгу вне коллекции не меняет список.
